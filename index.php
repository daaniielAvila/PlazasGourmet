    ...
    <section class="video-section">
        <video autoplay muted loop class="background-video">
            <source src="./33256-396487978.mp4" type="video/mp4">
        ...
        <div class="projcard-container">
            ...
            <div class="projcard projcard-blue">
              <div class="projcard-innerbox">
                <img class="projcard-img" src="https://media-cdn.tripadvisor.com/media/photo-s/1c/36/a4/1c/the-pizza-pasta-kitchen.jpg" />
                <div class="projcard-textbox">
                  <div class="projcard-title">Comida Italiana</div>
            ...
            <div class="projcard projcard-red">
              <div class="projcard-innerbox">
                <img class="projcard-img" src="https://images.ecestaticos.com/KMqSvKqy4k3ZDwy-IDfujRoaCzA=/3x166:2088x1264/600x315/filters:fill(white):format(jpg)/f.elconfidencial.com%2Foriginal%2F0d6%2F8de%2F0e0%2F0d68de0e0f424d8279f61e9de356e8a1.jpg" />
                <div class="projcard-textbox">
                  <div class="projcard-title">Comida China</div>
                  <div class="projcard-bar"></div>
            ...
            <div class="projcard projcard-green">
              <div class="projcard-innerbox">
                <img class="projcard-img" src="https://imagenes.20minutos.es/files/image_1920_1080/uploads/imagenes/2023/03/10/comida-turca.jpeg" />
                <div class="projcard-textbox">
                  <div class="projcard-title">Comida Turca </div>
                  <div class="projcard-bar"></div>
            ...
            <div class="projcard projcard-customcolor" style="--projcard-color: #F5AF41;">
              <div class="projcard-innerbox">
                <img class="projcard-img" src="https://www.hogarmania.com/archivos/202207/platos-tipicos-espana-portada-668x400x80xX-1.jpg" />
                <div class="projcard-textbox">
                  <div class="projcard-title">Comida Española</div>
                  <div class="projcard-bar"></div>
            ...
            <div class="projcard projcard-blue">
              <div class="projcard-innerbox">
                <img class="projcard-img" src="https://img.freepik.com/fotos-premium/variedad-recetas-indias-comida-variada_79295-7226.jpg" />
                <div class="projcard-textbox">
                  <div class="projcard-title">Comida Variada</div>
                  <div class="projcard-bar"></div>
            ...
            <div class="container-cards">
              <?php include './back/sacardatos.php'; ?>
          </div>
